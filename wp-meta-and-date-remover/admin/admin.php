...
&lt;?php } ?&gt;
    ...
    <div class=" w-1/4 p-4 shadow-sm flex flex-col justify-center rounded-sm bg-white">
        ...
        <div class="mt-10">
            <a target="_blank" href="https://wordpress.org/plugins/imagepilot/">
            <img class="mb-2" src="<?php echo plugin_dir_url( __FILE__ ) . '/img/imagepilot.svg' ?>">
            <label><span class="text-lg">ImagePilot</span><br>Unlimited image compression plugin for WordPress</label>
            </a>
        </div>
        ...
        <p class="mt-2 text-gray-600 hidden">(Third party service)</p>
