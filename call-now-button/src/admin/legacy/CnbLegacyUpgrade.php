...
class CnbLegacyUpgrade {
    ...
    private function feature_comparison_free_promobox() {
        ...
        <p class="top-0">Our cloud product <strong>NowButtons</strong> offers many additional features such as SMS, mail, Messenger, WhatsApp and much much more. Sign up to add all features and functionality from the NowButtons free plan to your plugin.</p>
