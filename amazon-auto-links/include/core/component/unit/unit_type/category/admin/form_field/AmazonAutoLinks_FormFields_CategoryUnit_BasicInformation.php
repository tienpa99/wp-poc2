 ...
 */
class AmazonAutoLinks_FormFields_CategoryUnit_BasicInformation extends AmazonAutoLinks_FormFields_Unit_Base {
    ...
    public function get( $sFieldIDPrefix='' ) {
        ...
        $_aFields = array(
            ...
            array(
                ...
                'description'   => AmazonAutoLinks_Message::getLocaleFieldGuide(),
                'default'       => 'US',
            ),
            array(
                'field_id'      => 'sort',
