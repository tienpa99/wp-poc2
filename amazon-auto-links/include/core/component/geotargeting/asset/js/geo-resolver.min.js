...
return!1});var _aUnmodified=[];var _aModified=[];_oHrefs.each(function(index){var _match=this.href.match(/.+\/([A-Z0-9]{10})/);if(_match){this.href='undefined'!==typeof _match[1]?_oLocale.searchURL+_match[1]:this.href;_aModified.push(this.href);return!0}
...
if(-1!==this.href.indexOf('aws/cart/add.html')){this.href=this.href.replace(/^(https?:\/\/)(www\.amazon\..+?)(\W.+)/,'$1'+_oLocale.domain+'$3');_aModified.push(this.href);return!0}
