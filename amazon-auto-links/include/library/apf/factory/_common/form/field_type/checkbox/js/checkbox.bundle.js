...
(function($){
  ...
  var apfCheckBox = AmazonAutoLinks_AdminPageFrameworkFieldTypeCheckbox;
  ...
  $( document ).ready( function(){
    ...
    $( document ).ready( function(){
      ...
      _body.on( 'click', '.select_all_button_container', function() {
        $( this ).selectAllAmazonAutoLinks_AdminPageFrameworkCheckboxes();
        return false;
      } );
      ...
      _body.on( 'click', '.select_none_button_container', function() {
        $( this ).deselectAllAmazonAutoLinks_AdminPageFrameworkCheckboxes();
        return false;
      } );
    });
