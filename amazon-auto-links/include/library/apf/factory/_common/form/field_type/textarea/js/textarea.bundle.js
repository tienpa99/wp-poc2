...
(function($){
  ...
  /** global: AmazonAutoLinks_AdminPageFrameworkFieldTypeTextArea */
  var apfTextArea = AmazonAutoLinks_AdminPageFrameworkFieldTypeTextArea;
  ...
  $( document ).ready( function(){
    ...
    var updateFoundEditors = function ( oElements ) {
      ...
      oElements.each( function ( iIndex ) {
        ...
        var oSettings = $().getAmazonAutoLinks_AdminPageFrameworkInputOptions( oWrap.attr( 'data-id' ) );
    ...
    $().registerAmazonAutoLinks_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function ( oCloned, aModel ) {
          ...
          var _oSettings = $().getAmazonAutoLinks_AdminPageFrameworkInputOptions( _oWrap.attr( 'data-id' ) );
        ...
        stopped_sorting_sections: function ( oSections ) {
          ...
          setTimeout( function () {
            var _oFields = $( oSections ).find( '.amazon-auto-links-field' );
            updateFoundEditors( _oFields );
          }, 100 );
        ...
        saved_widget: function ( oWidget ) {
          ...
          $( oWidget ).find( '.amazon-auto-links-field' ).each( function ( iIndex ) {
            ...
            // Store the settings.
            $().storeAmazonAutoLinks_AdminPageFrameworkInputOptions(
              oWrap.attr( 'data-id' ),
              {
    ...
    // Initialize
    $( '.amazon-auto-links-textarea-data-input' ).each( function(){
