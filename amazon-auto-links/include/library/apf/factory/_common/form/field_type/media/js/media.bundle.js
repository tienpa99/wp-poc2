...
var apfMedia = AmazonAutoLinks_AdminPageFrameworkMediaFieldType;
...
(function ( $ ) {
  ...
  var setAmazonAutoLinks_AdminPageFrameworkMediaUploader;
  ...
  $( document ).ready( function () {
    ...
    if ( ! apfMedia.hasMediaUploader ) {
       ...
       */
      setAmazonAutoLinks_AdminPageFrameworkMediaUploader = function ( sInputID, bMultiple, fExternalSource ) {
            ...
            if ( typeof (_oMedia) !== 'undefined' ) {
              ...
              _oMediaUploader.state().get( 'selection' ).each( function ( oAttachment, iIndex ) {
                ...
                var _oFieldContainer = 'undefined' === typeof _oNewField
                  ? $( '#' + sInputID ).closest( '.amazon-auto-links-field' )
                  : _oNewField;
                _oNewField = $( this ).addAmazonAutoLinks_AdminPageFrameworkRepeatableField( _oFieldContainer.attr( 'id' ) );
    ...
    $( document ).ready( function () {
      ...
      $( 'a.select_media.button' ).each( function() {
        setAmazonAutoLinks_AdminPageFrameworkMediaUploader( $( this ).data( 'input_id' ), $( this ).data( 'repeatable' ), $( this ).data( 'enable_external_source' ) );
      } );
