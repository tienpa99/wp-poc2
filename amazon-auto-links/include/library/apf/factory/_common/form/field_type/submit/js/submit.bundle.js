...
(function($){
  ...
  $( document ).ready( function(){
    ...
    $( '.amazon-auto-links-field-submit .submit-confirm-container input[type=checkbox]' ).each( function( index, value ){
      $( this ).closest( '.amazon-auto-links-field-submit' ).find( 'input[type=submit]' ).on( 'click', function( event ){
        var _fieldSubmit = $( this ).closest( '.amazon-auto-links-field-submit' );
        _fieldSubmit.find( '.submit-confirmation-warning' ).remove(); // previous error message
        var _confirmCheckbox = $( this ).closest( '.amazon-auto-links-field-submit' ).find( '.submit-confirm-container input[type=checkbox]' );
