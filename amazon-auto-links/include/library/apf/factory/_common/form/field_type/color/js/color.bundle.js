...
(function ( $ ) {
  ...
  var apfColor = AmazonAutoLinks_AdminPageFrameworkColorFieldType;

  var registerAmazonAutoLinks_AdminPageFrameworkColorPickerField = function ( osSubjectInput, aOptions ) {
    ...
    var _aDefaults = {
      ...
      change: function ( event, ui ) {
        $( osTargetInput ).trigger( 'amazon-auto-links_field_type_color_changed' );
      ...
      clear: function ( event, ui ) {
        $( osTargetInput ).trigger( 'amazon-auto-links_field_type_color_cleared' );
  ...
  $( document ).ready( function () {
    ...
    // Initialization
    $( '.amazon-auto-links-field-color-picker' ).each( function () {
      registerAmazonAutoLinks_AdminPageFrameworkColorPickerField( $( this ).data( 'input_id' ) );
    } );
