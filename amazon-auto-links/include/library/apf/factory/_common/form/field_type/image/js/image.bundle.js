...
(function ( $ ) {
  ...
  var setAmazonAutoLinks_AdminPageFrameworkImageUploader;
  ...
  $( document ).ready( function () {
    ...
    $( '.select_image.button' ).each( function() {
      setAmazonAutoLinks_AdminPageFrameworkImageUploader( $( this ).data( 'input_id' ), $( this ).data( 'repeatable' ), $( this ).data( 'enable_external_source' ) );
    } );
    // Remove buttons
