...
if ( ! class_exists( 'AmazonAutoLinks_DateTimeCustomFieldType' ) ) :
 ...
 *      'field_id'      => 'date_time',
 *      'type'          => 'date_time',
 *      'title'         => __( 'Date & Time', 'amazon-auto-links' ),
 ...
 *      'type'          => 'date_time',
 *      'title'         => __( 'Multiple Date and Time', 'amazon-auto-links' ),
 *      'label'         => __( 'Default', 'amazon-auto-links' ), 
 *      'time_format'   => 'H:mm',
 *      'date_format'   => 'yy-mm-dd', // yy/mm/dd is the default format.
 *      'delimiter'     => '<br />',     
 *      'attributes'    => array(
 ...
 *      ),     
 *      array(
 *          'label'         => __( 'AM PM', 'amazon-auto-links' ), 
 *          'time_format'   => 'hh:mm tt',
 *      ),
 *      array(
 *          'label'         => __( 'Time Zone', 'amazon-auto-links' ), 
 *          'time_format'   => 'hh:mm tt z',
 *      ),
 *      array(
 *          'label'         => __( 'Number Of Months', 'amazon-auto-links' ), 
 *          'options'       => array(
 *              'numberOfMonths' => 3,
 *          ),
 *      ),     
 *      array(
 *          'label'         => __( 'Min & Max Dates', 'amazon-auto-links' ), 
 *          'options'       => array(
 *              'numberOfMonths'    => 2,
 *              'minDate'           => 0,
 *              'maxDate'           => 30,
 ...
 *      'type'          => 'date_time',
 *      'title'         => __( 'Repeatable Date & Time Fields', 'amazon-auto-links' ),
 *      'repeatable'    => true,
 *      'options'       => array(
 *          'timeFormat'    => 'HH:mm:ss',
 *          'stepHour'      => 2,
 ...
 *      'type'          => 'date_time',
 *      'title'         => __( 'Sortable', 'amazon-auto-links' ),
 *      'sortable'      => true,
 *      'attributes'    => array(
 *          'size' => 30,
 *      ),
 ...
 *              array(
 *                  'value' => -300,
 *                  'label' => __( 'Eastern', 'amazon-auto-links' ),
 *              ),
 *              array(
 *                  'value' => -360,
 *                  'label' => __( 'Central', 'amazon-auto-links' ),
 *              ),     
 *              array(
 *                  'value' => -420,
 *                  'label' => __( 'Mountain', 'amazon-auto-links' ),
 *              ),     
 *              array(
 *                  'value' => -480,
 *                  'label' => __( 'Pacific', 'amazon-auto-links' ),
 *              ),     
 *          ),
 *      ),
 ...
 * @version     1.0.0
 */
class AmazonAutoLinks_DateTimeCustomFieldType extends AmazonAutoLinks_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    jQuery().registerAmazonAutoLinks_AdminPageFrameworkCallbacks( {  
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            var sOptionID = jQuery( oCloned ).closest( '.amazon-auto-links-sections' ).attr( 'id' ) 
                + '_' 
                + jQuery( oCloned ).closest( '.amazon-auto-links-fields' ).attr( 'id' );    // sections id + _ + fields id 
    ...
    protected function getField( $aField ) { 
        ...
        return 
            $aField['before_label']
            . "<div class='amazon-auto-links-input-label-container'>"
                . "<label for='{$aField['input_id']}'>"
                    . $aField['before_input']
                    . ( $aField['label'] && ! $aField['repeatable']
                        ? "<span class='amazon-auto-links-input-label-string' style='min-width:" . $this->getLengthSanitized( $aField['label_min_width'] ) . ";'>" . $aField['label'] . "</span>"
                        : "" 
                    )
            ...
            return 
                "<script type='text/javascript' class='date-time-picker-enabler-script'>
                    jQuery( document ).ready( function() {
                        ...
                        var sOptionID = jQuery( '#{$sInputID}' ).closest( '.amazon-auto-links-sections' ).attr( 'id' ) + '_' + jQuery( '#{$sInputID}' ).closest( '.amazon-auto-links-fields' ).attr( 'id' );
