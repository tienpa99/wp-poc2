...
if ( ! class_exists( 'AmazonAutoLinks_TimeRangeCustomFieldType' ) ) :
 ...
 *      'field_id'      => 'time_range',
 *      'title'         => __( 'Time Range', 'amazon-auto-links' ),
 *      'type'          => 'time_range',
 *  ),    
 *  array( // Sortable and repeatable time_range picker
 *      'field_id'      => 'time_range_repeatable',
 *      'title'         => __( 'Repeatable Time Range', 'amazon-auto-links' ),
 *      'type'          => 'time_range',
 ...
 * @version     1.0.1
 */
class AmazonAutoLinks_TimeRangeCustomFieldType extends AmazonAutoLinks_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    protected function getStyles() {
        ...
        return "/* Date Picker */
            ...
            .form-table td .amazon-auto-links-field-time_range label {
                display: inline-block;
                width:    auto;
                padding-right: 1em;
            }
            .form-table td .amazon-auto-links-field-time_range .amazon-auto-links-repeatable-field-buttons {
                margin-bottom: 0;
            }
            " . PHP_EOL;
    }    
