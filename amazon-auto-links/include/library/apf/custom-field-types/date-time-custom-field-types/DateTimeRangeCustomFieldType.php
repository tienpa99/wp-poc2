...
if ( ! class_exists( 'AmazonAutoLinks_DateTimeRangeCustomFieldType' ) ) :
 ...
 *      'title'         => __( 'Date Time Range', 'amazon-auto-links' ),
 *      'type'          => 'date_time_range',
 *  ),     
 *  array( // Repeatable and sortable date_time_range picker
 *      'field_id'      => 'date_time_range_repeatable',
 *      'title'         => __( 'Repeatable Date Time Range', 'amazon-auto-links' ),
 *      'type'          => 'date_time_range',
 ...
 * @version     1.0.1
 */
class AmazonAutoLinks_DateTimeRangeCustomFieldType extends AmazonAutoLinks_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    protected function getStyles() {
        ...
        return "/* Date Picker */
            ...
            .form-table td .amazon-auto-links-field-date_time_range label {
                display: inline-block;
                width:    auto;
                padding-right: 1em;
            }
            .form-table td .amazon-auto-links-field-date_time_range .amazon-auto-links-repeatable-field-buttons {
                margin-bottom: 0;
            }
            " . PHP_EOL;
    }    
    ...
    protected function getField( $aField ) { 
        ...
        // Labels
        $aField['label']['from'] = isset( $aField['label']['from'] ) ? $aField['label']['from'] : __( 'From', 'amazon-auto-links' ) . ':';
        $aField['label']['to'] = isset( $aField['label']['to'] ) ? $aField['label']['to'] : __( 'To', 'amazon-auto-links' ) . ':';
        ...
        return 
            ...
            . "<div class='amazon-auto-links-input-label-container'>"
                . "<label for='{$aField['input_id']}_from'>"
                    . $aField['before_input']
                    . ( $aField['label'] 
                        ? "<span class='amazon-auto-links-input-label-string' style='min-width:" . $this->getLengthSanitized( $aField['label_min_width'] ) . ";'>" . $aField['label']['from'] . "</span>"
                        : "" 
                    )
                ...
                . "<label for='{$aField['input_id']}_to'>"
                    . $aField['before_input']
                    . ( $aField['label'] 
                        ? "<span class='amazon-auto-links-input-label-string' style='min-width:" . $this->getLengthSanitized( $aField['label_min_width'] ) . ";'>" . $aField['label']['to'] . "</span>"
                        : "" 
                    )
