...
if ( ! class_exists( 'AmazonAutoLinks_DateRangeCustomFieldType' ) ) :
 ...
 *      'title'         => __( 'Repeatable Date Range', 'amazon-auto-links' ),
 *      'type'          => 'date_range',
 *      'repeatable'    => true,
 *      'sortable'      => true,
 *      'options'       => array(
 ...
 * @version     1.0.1
 */
class AmazonAutoLinks_DateRangeCustomFieldType extends AmazonAutoLinks_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    protected function getStyles() {
        ...
        return "/* Date Picker */
            ...
            .form-table td .amazon-auto-links-field-date_range label {
                display: inline-block;
                width:    auto;
                padding-right: 1em;
            }
            .form-table td .amazon-auto-links-field-date_range .amazon-auto-links-repeatable-field-buttons {
                margin-bottom: 0;
            }
            " . PHP_EOL;
    }    
