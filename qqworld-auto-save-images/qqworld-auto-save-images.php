							...
							<form id="smart-shopping-guide-container" class="mb-5">
								<div class="row">
									...
									<dl class="col-md-6">
										...
										<dd>
											<p><label><input type="radio" name="mode" value="single-site" checked /> <?php printf(_x('1-<span id="number-1">%d</span>', 'activation', $this->text_domain), 9); ?> <sup>&#9313;</sup></label></p>
											<p><label><input type="radio" name="mode" value="unlimited" /> <?php printf(_x('<span id="number-2">%d</span> and above', 'activation', $this->text_domain), 10); ?></label></p>
