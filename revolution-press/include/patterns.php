...
register_block_pattern_category(
    'revolution-press',
    array( 'label' => __( 'Revolution Press Patterns', 'revolution-press' ) )
);

register_block_pattern(
    'revolution-press/about-us',
    array(
        'title'   => __( 'About US', 'revolution-press' ),
		'categories' => array( 'revolution-press' ),
        'content' => '<!-- wp:columns {"align":"wide","className":"rp-about-me"} -->
