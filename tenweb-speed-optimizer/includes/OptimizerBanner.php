...
class OptimizerBanner
{
    ...
    private function setArgs() {
        global $pagenow;
        $auto_update_banner_array = array('plugins.php', 'edit.php');
        $nps_survey_banner_array = array('index.php', 'edit.php');
    ...
    private function enqueueNPSScripts() {
        ...
        wp_enqueue_style(
            ...
            array('two_banner_css'),
            TENWEB_SO_VERSION
        );
        wp_enqueue_script(
            'two_nps_survey_js',
            TENWEB_SO_URL . '/assets/js/nps_survey.js',
            array('jquery', 'two_speed_js','banner_main_js'),
            TENWEB_SO_VERSION
        );
    }
