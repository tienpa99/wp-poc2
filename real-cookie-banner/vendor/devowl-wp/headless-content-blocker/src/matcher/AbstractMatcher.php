...
abstract class AbstractMatcher
{
    ...
    protected function applyCommonAttributes($result, $match, $linkAttribute = null, $link = null)
    {
        ...
        if (\in_array($match->getTag(), Constants::HTML_ATTRIBUTE_TYPE_FOR, \true)) {
            ...
            $match->setAttribute($newTypeAttribute, $match->getAttribute(Constants::HTML_ATTRIBUTE_TYPE_NAME, $match->getTag() === 'script' ? Constants::HTML_ATTRIBUTE_TYPE_JS : Constants::HTML_ATTRIBUTE_TYPE_CSS));
