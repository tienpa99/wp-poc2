...
class NavMenuList
{
    ...
    public function get($checkAlreadyAppliedBy = null)
    {
        ...
        foreach ($nav_menus as $nav_menu) {
            $row = ['id' => \md5('legacy_nav' . $nav_menu->term_id), 'type' => 'legacy_nav', 'term_id' => $nav_menu->term_id, 'name' => $nav_menu->name, 'locations' => new stdClass(), 'languages' => $this->getLanguagesForMenu($nav_menu), 'edit_url' => \admin_url(\sprintf('nav-menus.php?action=edit&menu=%d', $nav_menu->term_id))];
            // Find location
