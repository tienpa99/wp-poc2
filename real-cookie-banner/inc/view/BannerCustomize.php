...
class BannerCustomize extends AbstractCustomizePanel
{
    ...
    public function enableOptionsAutoload()
    {
        ...
        $adminDefaultLegalTexts = Legal::getDefaultTexts();
        ...
        new LanguageDependingOption($comp, Legal::SETTING_IMPRINT_LABEL, $adminDefaultLegalTexts['imprint']);
        new LanguageDependingOption($comp, Legal::SETTING_IMPRINT_EXTERNAL_URL, '', LanguageDependingOption::DEFAULT_USE_NON_EMPTY_FROM_OTHER_LANGUAGES);
        new LanguageDependingOption($comp, Legal::SETTING_PRIVACY_POLICY_LABEL, $adminDefaultLegalTexts['privacyPolicy']);
        new LanguageDependingOption($comp, Legal::SETTING_PRIVACY_POLICY_EXTERNAL_URL, '', LanguageDependingOption::DEFAULT_USE_NON_EMPTY_FROM_OTHER_LANGUAGES);
        ...
        new LanguageDependingOption($comp, Texts::SETTING_EPRIVACY_USA, $adminDefaultTextsBanner['ePrivacyUSA']);
