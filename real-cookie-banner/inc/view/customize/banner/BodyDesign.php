...
class BodyDesign
{
    ...
    const CUSTOM_HTML_BUTTON_ACCEPT_ALL_ONE_ROW_LAYOUT_NOTICE = self::SECTION . '-custom-html-button-accept-all-one-row-layout-notice';
