...
class Config
{
    ...
    public function rest_api_init()
    {
        ...
        \register_rest_route($namespace, '/modal-hint', ['methods' => 'PUT', 'callback' => [$this, 'routePutModalHintSeen'], 'permission_callback' => [$this, 'permission_callback'], 'args' => ['identifier' => ['type' => 'string', 'required' => \true]]]);
    ...
    {
        return new WP_REST_Response(['success' => ModalHints::getInstance()->setSeen($request->get_param('identifier'))]);
    }
    /**
     * See API docs.
     *
