 ...
 */
class FiveStarRestaurantReservationsPreset extends AbstractBlockerPreset
{
    const IDENTIFIER = PresetIdentifierMap::FIVE_STAR_RESTAURANT_RESERVATION;
