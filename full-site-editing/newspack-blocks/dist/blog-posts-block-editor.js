  ...
  constructor() {
    ...
    (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(this, "renderInspectorControls", () => {
      ...
      const imageSizeOptions = [{
        ...
        __('Small', 'full-site-editing'),
        shortName:
        /* translators: abbreviation for small size */
        __('S', 'full-site-editing')
      }, {
        value: 2,
        label:
        /* translators: label for medium size option */
        __('Medium', 'full-site-editing'),
        shortName:
        /* translators: abbreviation for medium size */
        __('M', 'full-site-editing')
      }, {
        value: 3,
        label:
        /* translators: label for large size option */
        __('Large', 'full-site-editing'),
        shortName:
        /* translators: abbreviation for large size */
        __('L', 'full-site-editing')
      }, {
        value: 4,
        label:
        /* translators: label for extra large size option */
        __('Extra Large', 'full-site-editing'),
        shortName:
        /* translators: abbreviation for extra large size */
        __('XL', 'full-site-editing')
      }];
      const colGapOptions = [{
        value: 1,
        label:
...
const {
  ...
  attributes,
  category
} = _block_json__WEBPACK_IMPORTED_MODULE_8__; // Name must be exported separately.
...
function* getPostsForBlock(block) {
  ...
  if (posts === undefined) {
    const url = (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_2__.addQueryArgs)(restUrl, { ...block.postsQuery,
...
const createFetchPostsSaga = blockNames => {
  ...
  function* fetchPosts() {
    ...
    const blockQueries = (0,_utils__WEBPACK_IMPORTED_MODULE_7__/* .getBlockQueries */ .Pi)(blocks, blockNames); // Use requested specific posts ids as the starting state of exclusion list.
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(blockName, { ..._synced_newspack_blocks_blocks_homepage_articles_index__WEBPACK_IMPORTED_MODULE_4__/* .settings */ .Xd,
