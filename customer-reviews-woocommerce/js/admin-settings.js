(function() {
	jQuery(document).ready(function() {
		...
		jQuery('.cr-cus-atts-table').on( 'click', '.cr-cus-atts-button-manage', function( e ) {
			jQuery(this).parents('.cr-cus-atts-table').find('.cr-cus-atts-menu').addClass('cr-generic-hide');
