...
* Displays blocked count on settings screen (when [enabled](https://perishablepress.com/bbq-firewall-count-blocked-requests/))
* Updates [whitelist/blacklist addons](https://perishablepress.com/bbq-whitelist-blacklist/)
* Updates [customize addon](https://perishablepress.com/customize-bbq-firewall/)
