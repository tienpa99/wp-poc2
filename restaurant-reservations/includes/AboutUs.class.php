		...
		<div class='rtb-about-us-tabs'>
			...
			<div class='rtb-about-us-tab rtb-hidden' data-tab='lite_vs_premium'>
				...
				<div class='rtb-about-us-tab-buttons'>
					...
					<?php printf( __( '<a href="%s" target="_blank" class="rtb-about-us-tab-button rtb-about-us-tab-button-purchase">Buy Ultimate Version</a>', 'restaurant-reservations' ), 'https://www.fivestarplugins.com/license-payment/?Selected=RTU&Quantity=1&utm_source=admin_about_us' ); ?>
				</div>
