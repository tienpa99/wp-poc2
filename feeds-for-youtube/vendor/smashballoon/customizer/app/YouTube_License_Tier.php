...
class YouTube_License_Tier extends License_Tier
{
    ...
    {
        $features_list = ['personal' => ['channel_feeds', 'favorites_feeds', 'playlist_feeds', 'carousel_feeds', 'combine_feeds', 'performance_optimization', 'downtime_prevention_system', 'gbpr_compliant'], 'business' => ['call_to_actions', 'search_feeds', 'single_feeds', 'feeds_templates', 'convert_videos_to_cpt'], 'developer' => ['live_feeds', 'video_filtering', 'feed_themes']];
