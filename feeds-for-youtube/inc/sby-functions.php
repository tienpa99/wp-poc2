...
/**
 * Set header referer URL for remote requests
 *
 * @since 2.0
 */
function sby_filter_remote_request_args( $args, $url ) {
	$args['headers']['referer'] = home_url();

	return $args;
}

add_filter( 'http_request_args', 'sby_filter_remote_request_args', 10, 2 );