...
class Options {
	...
	public static function encode_options_object( $options ) {
		...
		// TODO find out why I did this weird transformation and simplify it (I think it had something to do with correctly transforming a nested array into an object with nested objects)
...
//		error_log(print_r($target_array, true));
	...
	public static function is_at_least_one_paid_ads_pixel_active() {
		return self::is_facebook_enabled()
			|| self::is_google_ads_purchase_conversion_active()
