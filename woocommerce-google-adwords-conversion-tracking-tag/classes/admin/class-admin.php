...
class Admin
{
    ...
    public function options_validate( $input )
    {
        ...
        if ( isset( $input['google']['analytics']['universal']['property_id'] ) ) {
            ...
            $input['google']['analytics']['universal']['property_id'] = Helpers::settings_trim( $input['google']['analytics']['universal']['property_id'] );
        ...
        if ( isset( $input['google']['analytics']['ga4']['measurement_id'] ) ) {
            // Trim whitespace, newlines and quotes
            $input['google']['analytics']['ga4']['measurement_id'] = Helpers::settings_trim( $input['google']['analytics']['ga4']['measurement_id'] );
        ...
        if ( isset( $input['google']['analytics']['ga4']['api_secret'] ) ) {
            // Trim whitespace, newlines and quotes
            $input['google']['analytics']['ga4']['api_secret'] = Helpers::settings_trim( $input['google']['analytics']['ga4']['api_secret'] );
        ...
        if ( isset( $input['google']['analytics']['ga4']['data_api']['property_id'] ) ) {
            // Trim whitespace, newlines and quotes
            $input['google']['analytics']['ga4']['data_api']['property_id'] = Helpers::settings_trim( $input['google']['analytics']['ga4']['data_api']['property_id'] );
        ...
        if ( isset( $input['google']['ads']['conversion_id'] ) ) {
            // Trim whitespace, newlines and quotes
            $input['google']['ads']['conversion_id'] = Helpers::settings_trim( $input['google']['ads']['conversion_id'] );
        ...
        if ( isset( $input['google']['ads']['conversion_label'] ) ) {
            // Trim whitespace, newlines and quotes
            $input['google']['ads']['conversion_label'] = Helpers::settings_trim( $input['google']['ads']['conversion_label'] );
        ...
        if ( isset( $input['google']['ads']['phone_conversion_label'] ) ) {
            // Trim whitespace, newlines and quotes
            $input['google']['ads']['phone_conversion_label'] = Helpers::settings_trim( $input['google']['ads']['phone_conversion_label'] );
        ...
        if ( isset( $input['google']['ads']['aw_merchant_id'] ) ) {
            // Trim whitespace, newlines and quotes
            $input['google']['ads']['aw_merchant_id'] = Helpers::settings_trim( $input['google']['ads']['aw_merchant_id'] );
        ...
        if ( isset( $input['google']['optimize']['container_id'] ) ) {
            // Trim whitespace, newlines and quotes
            $input['google']['optimize']['container_id'] = Helpers::settings_trim( $input['google']['optimize']['container_id'] );
        ...
        if ( isset( $input['facebook']['pixel_id'] ) ) {
            // Trim whitespace, newlines and quotes
            $input['facebook']['pixel_id'] = Helpers::settings_trim( $input['facebook']['pixel_id'] );
        ...
        if ( isset( $input['facebook']['capi']['token'] ) ) {
            // Trim whitespace, newlines and quotes
            $input['facebook']['capi']['token'] = Helpers::settings_trim( $input['facebook']['capi']['token'] );
        ...
        if ( isset( $input['facebook']['capi']['test_event_code'] ) ) {
            // Trim whitespace, newlines and quotes
            $input['facebook']['capi']['test_event_code'] = Helpers::settings_trim( $input['facebook']['capi']['test_event_code'] );
        ...
        if ( isset( $input['bing']['uet_tag_id'] ) ) {
            // Trim whitespace, newlines and quotes
            $input['bing']['uet_tag_id'] = Helpers::settings_trim( $input['bing']['uet_tag_id'] );
        ...
        if ( isset( $input['twitter']['pixel_id'] ) ) {
            // Trim whitespace, newlines and quotes
            $input['twitter']['pixel_id'] = Helpers::settings_trim( $input['twitter']['pixel_id'] );
        ...
        function validate_twitter_event( $event, $input, $options )
        {
            ...
            if ( isset( $input['twitter']['event_ids'][$event] ) ) {
                // Trim whitespace, newlines and quotes
                $input['twitter']['event_ids'][$event] = Helpers::settings_trim( $input['twitter']['event_ids'][$event] );
        ...
        if ( isset( $input['pinterest']['pixel_id'] ) ) {
            // Trim whitespace, newlines and quotes
            $input['pinterest']['pixel_id'] = Helpers::settings_trim( $input['pinterest']['pixel_id'] );
        ...
        if ( isset( $input['snapchat']['pixel_id'] ) ) {
            // Trim whitespace, newlines and quotes
            $input['snapchat']['pixel_id'] = Helpers::settings_trim( $input['snapchat']['pixel_id'] );
        ...
        if ( isset( $input['tiktok']['pixel_id'] ) ) {
            // Trim whitespace, newlines and quotes
            $input['tiktok']['pixel_id'] = Helpers::settings_trim( $input['tiktok']['pixel_id'] );
        ...
        if ( isset( $input['tiktok']['eapi']['token'] ) ) {
            // Trim whitespace, newlines and quotes
            $input['tiktok']['eapi']['token'] = Helpers::settings_trim( $input['tiktok']['eapi']['token'] );
        ...
        if ( isset( $input['tiktok']['eapi']['test_event_code'] ) ) {
            // Trim whitespace, newlines and quotes
            $input['tiktok']['eapi']['test_event_code'] = Helpers::settings_trim( $input['tiktok']['eapi']['test_event_code'] );
        ...
        if ( isset( $input['hotjar']['site_id'] ) ) {
            // Trim whitespace, newlines and quotes
            $input['hotjar']['site_id'] = Helpers::settings_trim( $input['hotjar']['site_id'] );
        ...
        if ( isset( $input['pixels']['reddit']['advertiser_id'] ) ) {
            // Trim whitespace, newlines and quotes
            $input['pixels']['reddit']['advertiser_id'] = Helpers::settings_trim( $input['pixels']['reddit']['advertiser_id'] );
        ...
        if ( isset( $input['google']['ads']['conversion_adjustments']['conversion_name'] ) ) {
            // Trim whitespace, newlines and quotes
            $input['google']['ads']['conversion_adjustments']['conversion_name'] = Helpers::settings_trim( $input['google']['ads']['conversion_adjustments']['conversion_name'] );
