...
class WPLE_SubAdmin extends WPLE_Admin_Page
{
    ...
    <div id="wple-vulnerability-scanner" style="' . esc_attr( $vuln_style ) . '">
      ...
      <div class="wple-vuln-countinner">
    ...
    public function wple_update_settings()
    {
        ...
        if ( $val == 0 ) {
            ...
            if ( $opt != 'upgrade_insecure' && $opt != 'disable_directory_listing' && $opt != 'ssl_monitoring' && $opt != 'vulnerability_scan' ) {
                $out = -10;
            }
            ...
            if ( false == get_option( 'wple_ssl_valid' ) && $opt != 'disable_directory_listing' && $opt != 'vulnerability_scan' ) {
                $out = 1;
                echo  $out ;
                exit;
            }
