...
//        }
    ...
    public static function custom_admin_pointers()
    {
        ...
        $new_pointer_content .= "This update provides the latest instructions for creating a YouTube API key, for both free and <a target=_blank href=" . self::$epbase . '/dashboard/pro-easy-video-analytics.aspx?ref=frompointer' . ">Pro versions</a>.";
