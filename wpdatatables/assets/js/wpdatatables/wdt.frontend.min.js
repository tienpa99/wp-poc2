...
if(tableDescription.hideBeforeLoad){dataTableOptions.fnInitComplete=function(){$(tableDescription.selector).animateFadeIn()}}
    -1!==$.inArray(tableDescription.currentSkin,["raspberry-cream","mojito"])&&(dataTableOptions.fnInitComplete=function(){let a=tableDescription.dataTableParams.order[0][0],e=tableDescription.dataTableParams.columnDefs[a].className.substring(tableDescription.dataTableParams.columnDefs[a].className.indexOf("column-")+7),r=tableDescription.tableId;addOutlineBorder(r,e),"mojito"===tableDescription.currentSkin&&(cubeLoaderMojito(r),tableDescription.showRowsPerPage&&hideLabelShowXEntries(r)),tableDescription.hideBeforeLoad&&$(tableDescription.selector).animateFadeIn()});
