...
class Core {
	...
	private function init() {
		...
		add_filter( 'wpmudev_notices_is_disabled', array( $this, 'wpmudev_remove_email_from_disabled_list' ), 10, 2 );
	 ...
	 * @return bool
	 */
	public function wpmudev_remove_email_from_disabled_list( $is_disabled, $type ) {
		if ( 'email' === $type ) {
			return false;
		}
