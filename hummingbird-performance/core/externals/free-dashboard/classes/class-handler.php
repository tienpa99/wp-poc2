...
if ( ! class_exists( __NAMESPACE__ . '\\Handler' ) ) {
	...
	final class Handler {
		 ...
		 * @return bool
		 */
		protected function is_disabled( $type ) {
			/**
			 * Filter to modify disabled notices list.
			 *
			 * @param array $disabled Disabled list.
			 */
			$disabled = apply_filters( 'wpmudev_notices_disabled_notices', $this->disabled );
			 ...
			 * @param string $type        Notice type.
			 */
			return apply_filters( 'wpmudev_notices_is_disabled', $is_disabled, $type );
		}
