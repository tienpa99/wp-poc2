<div id="nitropack-safemode-popup">
    ...
    <div id="np-safemode-content">    
        ...
        <?php esc_html_e( 'You can use our', 'nitropack' ); ?> <a href="https://support.nitropack.io/hc/en-us/articles/360060910574-Safe-Mode" target="blank"><?php esc_html_e( 'Safe Mode', 'nitropack' ); ?></a> <?php esc_html_e( 'instead.', 'nitropack' ); ?> <?php esc_html_e( 'Do you still want to deactivate?', 'nitropack' ); ?>
        </div>
        <div class="np-safemode-controls">
            ...
            <a id="np-safemode-go" class="btn btn-sec" type="submit" name="np-safemode-go" ><?php esc_html_e( 'No, enable "Safe Mode"', 'nitropack' ); ?></a>
        </div>
    </div>
</div>
