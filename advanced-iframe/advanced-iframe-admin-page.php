...
if (is_user_logged_in() && is_admin()) {
    ...
    if (isset($devOptions['blocked']) && $devOptions['blocked'] === "true") {
        echo '<div class="error"><p><strong><p>';
        _e('Your pro version was disabled because of license issues or your domain was blocked. Please contact the advanced iframe team <a href="https://codecanyon.net/user/mdempfle" target="_blank">here</a> to unblock your installation.', 'advanced-iframe');  
        echo '</p></strong></p></div>';      
        $evanto = false; 
    } 
