...
$html .= $this->interceptAjaxResize($id, $onload_resize_width, $resize_on_ajax, $resize_on_ajax_jquery,
 ...
 if ($default_options > 100*100) {
    $html .=  __('<p><small>powered by Advanced iFrame. Get the <a target="_blank" href="https://1.envato.market/Kd23v">Pro version on CodeCanyon</a>.</small></p>', 'advanced-iframe');
 }
 if ($loginPreview) {
