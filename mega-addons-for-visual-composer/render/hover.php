		...
		ob_start(); ?>
			<div class="ih-item <?php echo esc_attr($hover_effect); ?>"
				...
				<?php if (isset($caption_url['url']) && $caption_url['url'] != '') { ?>
					<a href="<?php echo esc_url($caption_url['url']); ?>" target="<?php echo esc_attr($caption_url['target']); ?>" title="<?php echo esc_html($caption_url['title']); ?>" rel="<?php echo esc_attr($popup) ?><?php if ($popup == 'pretty') { echo "Photo[pp_gal]"; } ?>">
				<?php } ?>
