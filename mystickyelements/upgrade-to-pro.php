...
$features = [
    ...
    [
        ...
        'tooltip' => esc_html__("Upload your own icons for your floating tabs", "mystickyelements")
    ],
    [
    ...
    [
        'title' => esc_html__("Available days and hours", "mystickyelements"),
