<p style="border: 1px solid #eee">
	<h3>How to add shortcode to menu bar?</h3>
	<h4>Please use this wonderful plugin to add shortcodes to menu bar.<br><a target="__blank" href="https://wordpress.org/plugins/shortcode-in-menus">Shortcode in menu</a></h4>
</p>
