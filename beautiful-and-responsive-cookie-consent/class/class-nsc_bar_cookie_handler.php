...
class nsc_bar_cookie_handler
{
    ...
    public function nsc_bar_cookie_cleanup()
    {
        ...
        if ($this->cookie_configs['compliance_type'] == "detailed" && !in_array($current_cookie_value, array_merge(array("savesettings", "detailed"), $allowedXClickValues))) {
            $this->nsc_bar_delete_cookie();
        }

        if ($this->cookie_configs['compliance_type'] == "detailedRev" && !in_array($current_cookie_value, array_merge(array("savesettings", "allowall"), $allowedXClickValues))) {
            $this->nsc_bar_delete_cookie();
        }
