...
if (!class_exists('WC_Email_Vendor_Commission_Transactions')) :
    ...
    class WC_Email_Vendor_Commission_Transactions extends WC_Email {
        ...
        function __construct() {
            ...
            //$this->heading = __('Vendor\'s New Transaction', 'multivendorx');
            //$this->subject = __('[{site_title}] New Transaction', 'multivendorx');
        ...
        function trigger($trans_id, $vendor_id) {
            ...
            $this->vendor = get_mvx_vendor_by_term($vendor_id);
        ...
        public function get_default_subject() {
            return apply_filters('mvx_vendor_commissions_transaction_email_subject', __('[{site_title}] New Transaction', 'multivendorx'), $this->object);
        }
        ...
        public function get_default_heading() {
            return apply_filters('mvx_vendor_commissions_transaction_email_heading', __('Vendor\'s New Transaction', 'multivendorx'), $this->object);
        }
