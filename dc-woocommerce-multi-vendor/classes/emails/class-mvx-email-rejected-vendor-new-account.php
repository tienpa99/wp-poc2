...
if (!class_exists('WC_Email_Rejected_New_Vendor_Account')) :
    ...
    class WC_Email_Rejected_New_Vendor_Account extends WC_Email {
        ...
        function __construct() {
            ...
            $this->title = __('Rejected Vendor Account', 'multivendorx');
        ...
        public function get_default_subject() {
            return apply_filters('mvx_rejected_vendor_new_account_email_subject', __('Your account on {site_title}', 'multivendorx'), $this->object);
        }
        ...
        public function get_default_heading() {
            return apply_filters('mvx_rejected_vendor_new_account_email_heading', __('Welcome to {site_title}', 'multivendorx'), $this->object);
        }
