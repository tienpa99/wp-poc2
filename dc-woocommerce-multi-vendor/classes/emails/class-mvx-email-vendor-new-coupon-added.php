...
if (!class_exists('WC_Email_Vendor_New_Coupon_Added')) :
    ...
    class WC_Email_Vendor_New_Coupon_Added extends WC_Email {
        ...
        function __construct() {
            ...
            $this->title = __('New Vendor Coupon', 'multivendorx');
            $this->description = __('Notification emails are sent when a new coupon is submitted by a vendor.', 'multivendorx');

            $this->heading = __('New coupon submitted: {coupon_name}', 'multivendorx');
            $this->subject = __('[{blogname}] New coupon submitted by {vendor_name} - {coupon_name}', 'multivendorx');
        ...
        public function get_default_subject() {
            return apply_filters('mvx_admin_new_vendor_coupon_email_subject', __('[{blogname}] New coupon submitted by {vendor_name} - {coupon_name}', 'multivendorx'), $this->object);
        }
        ...
        public function get_default_heading() {
            return apply_filters('mvx_admin_new_vendor_coupon_email_heading', __('New coupon submitted: {coupon_name}', 'multivendorx'), $this->object);
        }
