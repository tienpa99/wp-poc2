...
if (!class_exists('WC_Email_Vendor_New_Question')) :
    ...
    class WC_Email_Vendor_New_Question extends WC_Email {
        ...
        function __construct() {
            ...
            $this->title = __('Vendor New question', 'multivendorx');
    ...
    public function get_default_subject() {
        ...
        return apply_filters( 'mvx_vendor_new_question_email_subject', $subject, $this->object );
    }
    ...
    public function get_default_heading() {
        return apply_filters( 'mvx_vendor_new_question_email_heading', __('Product Query: {product_name}', 'multivendorx'), $this->object );
    }
