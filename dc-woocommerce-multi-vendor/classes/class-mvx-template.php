...
class MVX_Template {
    ...
    public function locate_template($template_name, $template_path = '', $default_path = '') {
        ...
        if (!$default_path) {
            $default_path = $MVX->plugin_path . 'templates/';
        }
    ...
    public function get_template_part($slug, $name = '') {
        ...
        if (!$template && $name && file_exists($MVX->plugin_path . "templates/{$slug}-{$name}.php"))
            $template = $MVX->plugin_path . "templates/{$slug}-{$name}.php";
