 ...
 *
 * Override this template by copying it to yourtheme/MultiVendorX/vendor-dashboard/vendor-announcements/vendor-announcements-unread.php
 *
 * @author 		MultiVendorX
...
<?php foreach( $posts_array as $post_element) { 
	...
	<div <?php if($tab3_counter >= 6) {?> class="mvx_hide_message3" <?php }?>>
		...
		<div class="msg_arrow_box"><a href="#" class="msg_stat_click"><i class="mvx-font ico-downarrow-2-icon"></i></a>
			<div class="msg_stat" style="display:none" >
				<ul class="mvx_msg_unread_ul" data-element="<?php echo $post_element->ID; ?>">
	...
	<div <?php if($tab3_counter >= 6) {?> class="mvx_hide_message" <?php }?> >
...
<?php }else{ ?>
    <div class="panel panel-default panel-padding text-center empty-panel"><?php _e('Sorry no unread announcement found.','multivendorx'); ?></div>  
<?php } ?>			
