...
;( function( $ ){
    ...
    $.widget( "factoryBootstrap467.fontControl", {
    ...
    $(function(){
        $.widget.bridge( "factoryBootstrap467_fontControl", $.factoryBootstrap467.fontControl );
        $(".factory-bootstrap-467 .factory-font").factoryBootstrap467_fontControl({});
    });
