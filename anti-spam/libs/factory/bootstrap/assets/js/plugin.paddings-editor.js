( function( $ ){
    ...
    $.fn.factoryBootstrap467_paddingsEditor = function (option) {
    ...
    $.fn.factoryBootstrap467_paddingsEditor.Constructor = PaddingsEditor;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-467 .factory-paddings-editor").factoryBootstrap467_paddingsEditor();
    });
