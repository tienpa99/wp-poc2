( function( $ ){
    ...
    $.fn.factoryBootstrap467_gradientControl = function (option) {
    ...
    $.fn.factoryBootstrap467_gradientControl.Constructor = GradientControl;
    
    // GRADIENT CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-467 .factory-gradient").factoryBootstrap467_gradientControl();
    });
