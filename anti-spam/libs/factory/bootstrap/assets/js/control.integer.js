( function( $ ){
    ...
    $.fn.factoryBootstrap467_integerControl = function (option) {
    ...
    $.fn.factoryBootstrap467_integerControl.Constructor = IntegerControl;
    
    // AUTO CREATING
    // ================================
    
    $(function(){
        $(".factory-bootstrap-467 .factory-integer").factoryBootstrap467_integerControl();
    });
