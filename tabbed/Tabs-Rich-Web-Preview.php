<?php
	$Rich_Web_Tabs = $RW_Tabs_NewOld == 'edit' ? filter_var(sanitize_text_field($RW_Tabs_Build_ID, FILTER_VALIDATE_INT)) : $RW_Tabs_Shortcode ;
	global $wpdb;
	...
	$RW_Tabs_DisableFunctions = false;
	if (count($Rich_Web_Tabs_Manager) == 0) {
		$RW_Tabs_New_Tab = true;
		$RW_Tabs_New_Tab_Theme = $RW_Tabs_Build_Theme;
		$RW_Tabs_Theme  = $wpdb->get_results($wpdb->prepare("SELECT * FROM $RWTabs_Themes_Table WHERE id = %d", $RW_Tabs_New_Tab_Theme));
		$RW_Tabs_Divide = explode("_", $RW_Tabs_Theme[0]->Rich_Web_Tabs_T_N_S);
		$RW_Tabs_Style_Number = end($RW_Tabs_Divide);
		$Rich_Web_Tabs_Theme_Prop = json_decode($RW_Tabs_Theme[0]->Rich_Web_Tabs_Prop);
		$RW_Tabs_Type = $RW_Tabs_Theme[0]->Rich_Web_Tabs_T_Ty;
		$RWTabs_Theme_T_N_S = $RW_Tabs_Theme[0]->Rich_Web_Tabs_T_N_S;
	}else{
	...
	?>
		<input type="text" style="display: none;" class="id_rw_tab" value="<?php echo  esc_attr($Rich_Web_Tabs); ?>">
		<?php
		if ($RW_Tabs_Type == 'Rich_Tabs_1') {  ?>
			<?php 
			$array = [];
			if ($RW_Tabs_New_Tab == true) {
				for ($i = 0; $i < 3; $i++) {
				...
				for ($i = 0; $i < count($Rich_Web_Tabs_Fields); $i++) {
					...
					if ($Rich_Web_Tabs_Fields[$i]->Tabs_Special_Color == "on" ) {
						$rw_color_arr[] = $Rich_Web_Tabs_Fields[$i]->Tabs_Special_Color_B;
						$rw_color_arr[] = $Rich_Web_Tabs_Fields[$i]->Tabs_Special_Color_H;
						$rw_color_arr[] = $Rich_Web_Tabs_Fields[$i]->Tabs_Special_Color_A;
						$imploded_arr = implode("^", $rw_color_arr);
						$array[$rand_id] = $imploded_arr;
					}else {
						$array[$rand_id] = '';
					}
				}
			...
			<style type="text/css" id="RW_Tabs_Style">
				...
				:root{
					--rw_tabs_section_align:<?php echo filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Align), FILTER_SANITIZE_STRING);?>;
					--rw_tabs_div_width:<?php echo filter_var(esc_attr($Rich_Web_Tabs_Theme_Prop->RWTabs_Width), FILTER_VALIDATE_INT); ?>%;
					--rw_tabs_menu_bgc:<?php echo filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_M_Bgc), FILTER_SANITIZE_STRING);?>;
					<?php 
					if ($RW_Tabs_T_NavMode == 'horizontal') { ?>
						--rw_tabs_menu_wrap : <?php echo filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_M_Wrap), FILTER_SANITIZE_STRING);?>;
						--rw_tabs_menu_pos : <?php echo filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_M_Pos), FILTER_SANITIZE_STRING);?>;
						--rw_tabs_menu_item_height:<?php echo filter_var(esc_attr($Rich_Web_Tabs_Theme_Prop->RWTabs_M_Height), FILTER_VALIDATE_INT); ?>px;
						--rw_tabs_menu_gap : <?php echo filter_var(esc_attr($Rich_Web_Tabs_Theme_Prop->RWTabs_M_Gap), FILTER_VALIDATE_INT); ?>px ;
					<?php } else { ?>
						--rw_tabs_v_menu_pos : <?php echo filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_M_Pos), FILTER_SANITIZE_STRING);?>;
						--rw_tabs_vertical_width :<?php echo filter_var(esc_attr($Rich_Web_Tabs_Theme_Prop->RWTabs_M_Width), FILTER_VALIDATE_INT); ?>px;
						--rw_tabs_menu_gap : '5px' ;
				    <?php } ?>
					--rw_tabs_vertical_container: calc(100% - var(--rw_tabs_vertical_width));
					--rw_tabs_vertical_max_width : calc(var(--rw_tabs_vertical_width) - 10px);

					--rw_tabs_menu_bc:<?php echo filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_M_BC), FILTER_SANITIZE_STRING);?>;          
					--rw_tabs_menu_item-bgc:<?php echo filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_Bgc_B), FILTER_SANITIZE_STRING);?>;          
					--rw_tabs_menu_item-c:<?php echo filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_Col_B), FILTER_SANITIZE_STRING);?>;          
					--rw_tabs_menu_item-h-bgc:<?php echo filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_Bgc_H), FILTER_SANITIZE_STRING);?>;          
					--rw_tabs_menu_item-a-bgc:<?php echo filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_Bgc_A), FILTER_SANITIZE_STRING);?>;          
					--rw_tabs_menu_item-h-c:<?php echo filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_Col_H), FILTER_SANITIZE_STRING);?>;          
					--rw_tabs_menu_item-a-c:<?php echo filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_Col_A), FILTER_SANITIZE_STRING);?>;          
					--rw_tabs_menu_item_text_max:calc( calc(2 * var(--rw_tabs_menu_item_height)) - 20px);

					--rw_tabs_text_font_size :<?php echo filter_var(esc_attr($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_FontSize), FILTER_VALIDATE_INT); ?>px;
					--rw_tabs_text_font_family :<?php echo filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_FontFamily), FILTER_SANITIZE_STRING);?>;
					--rw_tabs_text_icon_size :<?php echo filter_var(esc_attr($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_IconSize), FILTER_VALIDATE_INT); ?>px;
					--rw_tabs_text_max_height:calc(var(--rw_tabs_menu_item_height) - 10px);
					<?php if ($Rich_Web_Tabs_Theme_Prop->RWTabs_C_Type == 'color') { ?>
						--rw_tabs_content_bgc: <?php echo filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_C_Col_F), FILTER_SANITIZE_STRING);?>;
					<?php } else if($Rich_Web_Tabs_Theme_Prop->RWTabs_C_Type == 'gradient'){ ?>
						--rw_tabs_content_bgc: <?php echo filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_C_Col_F), FILTER_SANITIZE_STRING);?>;
						--rw_tabs_content_bgc2:<?php echo filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_C_Col_S), FILTER_SANITIZE_STRING);?>;
				    <?php } ?>
					
					
					
					--rw_tabs_content_br:<?php echo filter_var(esc_attr($Rich_Web_Tabs_Theme_Prop->RWTabs_C_BR), FILTER_VALIDATE_INT); ?>px;
					--rw_tabs_content_bw:<?php echo filter_var(esc_attr($Rich_Web_Tabs_Theme_Prop->RWTabs_C_BW), FILTER_VALIDATE_INT); ?>px;
					--rw_tabs_content_bc:<?php echo filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RW_Tabs_C_BC), FILTER_SANITIZE_STRING);?>;
				}
				#wpadminbar{
			...
			section#RW_Tabs_Section_T_H_<?php echo esc_html($Rich_Web_Tabs); ?>{
    			...
    			-ms-flex-wrap: nowrap;
    			flex-wrap: nowrap;
				-webkit-justify-content: var(--rw_tabs_section_align);
    			-ms-flex-pack: var(--rw_tabs_section_align);
    			justify-content: var(--rw_tabs_section_align);
			} 
			...
			div#RW_Tabs_T_H_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-desctop="vertical"]{
				-webkit-flex-direction: var(--rw_tabs_v_menu_pos);
    			-ms-flex-direction: var(--rw_tabs_v_menu_pos);
    			flex-direction: var(--rw_tabs_v_menu_pos);
			}
			div#RW_Tabs_T_H_<?php echo esc_html($Rich_Web_Tabs); ?>{
				width: var(--rw_tabs_div_width);
			}
			ul#RW_Tabs_T_Menu-H-<?php echo esc_html($Rich_Web_Tabs); ?>{
				background-color:var(--rw_tabs_menu_bgc) ;
			}
			div#RW_Tabs_T_H_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-desctop="vertical"] > ul#RW_Tabs_T_Menu-H-<?php echo esc_html($Rich_Web_Tabs); ?>{
    			...
    			-ms-flex-direction: column;
    			flex-direction: column;
				width: var(--rw_tabs_vertical_width);
			}
			div#RW_Tabs_T_H_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-desctop="vertical"] > div#Rich_Web_Tabs_tt_container<?php echo esc_html($Rich_Web_Tabs); ?>{
				width: var(--rw_tabs_vertical_container);
			}
			div#RW_Tabs_T_H_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-desctop="horizontal"] > ul#RW_Tabs_T_Menu-H-<?php echo esc_html($Rich_Web_Tabs); ?>{
    			...
    			-ms-flex-direction: row;
    			flex-direction: row;
				-webkit-justify-content: var(--rw_tabs_menu_pos);
				-ms-flex-pack: var(--rw_tabs_menu_pos);
				justify-content: var(--rw_tabs_menu_pos);
				gap:var(--rw_tabs_menu_gap);
				-webkit-flex-wrap: var(--rw_tabs_menu_wrap);
   				-ms-flex-wrap: var(--rw_tabs_menu_wrap);
   				flex-wrap: var(--rw_tabs_menu_wrap);
			}
			ul#RW_Tabs_T_Menu-H-<?php echo esc_html($Rich_Web_Tabs); ?> > li.RW_Tabs_T_Item-H > span > i{
				max-height: var(--rw_tabs_text_max_height);
    			overflow: hidden;
				padding: 7px;
			}
			div#RW_Tabs_T_H_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-desctop="horizontal"] > ul#RW_Tabs_T_Menu-H-<?php echo esc_html($Rich_Web_Tabs); ?> > li:not(.RW_Tabs_Img_Opt) > span > i{
				max-width: var(--rw_tabs_menu_item_text_max);
			}
			div#RW_Tabs_T_H_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-desctop="vertical"] > ul#RW_Tabs_T_Menu-H-<?php echo esc_html($Rich_Web_Tabs); ?> > li > span > i{
				max-width: var(--rw_tabs_vertical_max_width);
			}
			...
			div#RW_Tabs_T_H_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-desctop="horizontal"] > ul#RW_Tabs_T_Menu-H-<?php echo esc_html($Rich_Web_Tabs); ?> > .RW_Tabs_T_Item-H{
				height: var(--rw_tabs_menu_item_height);	
			}
			...
			ul#RW_Tabs_T_Menu-H-<?php echo esc_html($Rich_Web_Tabs); ?> > .RW_Tabs_T_Item-H[data-id="<?php echo esc_html($key);?>"]{
				...
				color: var(--rw_tabs_menu_item-c_<?php echo esc_html($RW_Tabs_Data_Sort);?>,var(--rw_tabs_menu_item-c));
			} 
			ul#RW_Tabs_T_Menu-H-<?php echo esc_html($Rich_Web_Tabs); ?> > .RW_Tabs_T_Item-H[data-id="<?php echo esc_html($key);?>"]:hover{
				...
				color: var(--rw_tabs_menu_item-h-c_<?php echo esc_html($RW_Tabs_Data_Sort);?>,var(--rw_tabs_menu_item-h-c));
			}
			ul#RW_Tabs_T_Menu-H-<?php echo esc_html($Rich_Web_Tabs); ?> > .RW_Tabs_T_Item-H[data-id="<?php echo esc_html($key);?>"].active{
				...
				color: var(--rw_tabs_menu_item-a-c_<?php echo esc_html($RW_Tabs_Data_Sort);?>,var(--rw_tabs_menu_item-a-c));
			}
			...
			ul#RW_Tabs_T_Menu-H-<?php echo esc_html($Rich_Web_Tabs); ?> > .RW_Tabs_T_Item-H > span > i > span {
				font-size: var(--rw_tabs_text_font_size);
				font-family: var(--rw_tabs_text_font_family);
				word-break: break-word;
			}
			ul#RW_Tabs_T_Menu-H-<?php echo esc_html($Rich_Web_Tabs); ?> > .RW_Tabs_T_Item-H > span > i {
				font-size: var(--rw_tabs_text_icon_size);
			}
			...
			{
				background: var(--rw_tabs_content_bgc) !important;
			}
			...
			{
				background: -webkit-linear-gradient(var(--rw_tabs_content_bgc), var(--rw_tabs_content_bgc2)) !important;
				background: -o-linear-gradient(var(--rw_tabs_content_bgc), var(--rw_tabs_content_bgc2)) !important;
				background: -moz-linear-gradient(var(--rw_tabs_content_bgc), var(--rw_tabs_content_bgc2)) !important;
				background: linear-gradient(var(--rw_tabs_content_bgc), var(--rw_tabs_content_bgc2)) !important;
			}
			.Rich_Web_Tabs_Tab_<?php echo esc_html($Rich_Web_Tabs); ?> div.Rich_Web_Tabs_tt_container<?php echo esc_html($Rich_Web_Tabs); ?>
			{
				border-radius:var(--rw_tabs_content_br) ; 
				-webkit-border-radius: var(--rw_tabs_content_br) ;
				-moz-border-radius: var(--rw_tabs_content_br) ;  
				border: var(--rw_tabs_content_bw) solid var(--rw_tabs_content_bc); 
			}
			...
			{
				background: var(--rw_tabs_content_bgc);
			}				
			...
			{
			    background: -webkit-linear-gradient( var(--rw_tabs_content_bgc), var(--rw_tabs_content_bgc2));
			    background: -o-linear-gradient( var(--rw_tabs_content_bgc), var(--rw_tabs_content_bgc2));
			    background: -moz-linear-gradient( var(--rw_tabs_content_bgc), var(--rw_tabs_content_bgc2));
			    background: linear-gradient( var(--rw_tabs_content_bgc), var(--rw_tabs_content_bgc2));
			}
			...
			<?php $array_fliped_key =  array_keys($array); ?>
			<section id="RW_Tabs_Section_T_H_<?php echo esc_html($Rich_Web_Tabs); ?>">
				...
				<ul id="RW_Tabs_T_Menu-H-<?php echo esc_html($Rich_Web_Tabs); ?>" class="<?php echo esc_attr($RWTabs_Theme_T_N_S); ?> Rich_Web_Tabs_tt_tabs Rich_Web_Tabs_tt_tabs<?php echo esc_html($Rich_Web_Tabs); ?>" data-rw-mobile="<?php echo esc_attr($Rich_Web_Tabs_Theme_Prop->RWTabs_Mobile); ?>" >
					...
					if ($RW_Tabs_New_Tab != true) {
						for ($i = 0; $i < count($Rich_Web_Tabs_Fields); $i++) : ?>
						 ...
						 for ($n=1; $n < 4; $n++) :
						 ?>
							<li  class="RW_Tabs_T_Item-H RW_Tabs_Non_Img_Opt <?php if ($n == 1) { echo 'active'; } ?> " data-id="<?php echo  esc_attr($array_fliped_key[$n - 1]); ?>" data-sort="<?php echo esc_attr($n); ?>">
									<span class="rich_web_tab_li_span RW_Tabs_Menu_Title">
										<i class='rich_web rich_web-none'>
												<span>Tab <?php echo esc_html($n); ?> </span>
										</i>
									</span>
								</li>
					<?php  endfor;  } ?>
				...
				<div id="Rich_Web_Tabs_tt_container<?php echo esc_html($Rich_Web_Tabs); ?>" class="Rich_Web_Tabs_tt_container Rich_Web_Tabs_tt_container<?php echo esc_html($Rich_Web_Tabs); ?>" data-style="<?php echo esc_attr($Rich_Web_Tabs_Theme_Prop->RWTabs_C_Type); ?>" >
					...
					if ($RW_Tabs_New_Tab != true) {
						for ($i = 0; $i < count($Rich_Web_Tabs_Fields); $i++) { ?>
							<div data-style="<?php echo esc_attr($Rich_Web_Tabs_Theme_Prop->RWTabs_C_Type); ?>" data-parent="<?php echo  esc_attr($array_fliped_key[$i]); ?>" class="Rich_Web_Tabs_tt_tab Rich_Web_Tabs_tt_tab<?php echo esc_html($Rich_Web_Tabs); ?> <?php if ($i == 0) { echo 'active'; } ?>"> <?php echo  wp_specialchars_decode($Rich_Web_Tabs_Fields[$i]->Tabs_Content); ?></div>
					<?php }  }else{
						for ($n=1; $n < 4; $n++) {  ?>
							<div data-style="<?php echo esc_attr($Rich_Web_Tabs_Theme_Prop->RWTabs_C_Type); ?>" data-parent="<?php echo  esc_attr($array_fliped_key[$n - 1]); ?>" class="Rich_Web_Tabs_tt_tab Rich_Web_Tabs_tt_tab<?php echo esc_html($Rich_Web_Tabs); ?> <?php if ($n == 1) { echo 'active'; } ?>">Tab <?php echo  esc_attr($n);?> Content</div>
						<?php }  } ?>
			...
			<script type="text/javascript">
			jQuery(function () {
				<?php if ($RW_Tabs_DisableFunctions != true) { ?>
					const noRightClick = document.getElementsByTagName("body")[0];
					noRightClick.addEventListener("contextmenu", e => e.preventDefault());
				<?php } ?>

				var RW_Tabs_Doc_Style = document.documentElement.style;
				<?php 
				$RW_Tabs_Data_For_Sort = 1; 
				foreach ($array as $key => $value) : 
				$array_exploded = [];
				if($value != ''): 
					$array_exploded = explode("^", $value);
				?>
				RW_Tabs_Doc_Style.setProperty('--rw_tabs_menu_item-c_<?php echo esc_js($RW_Tabs_Data_For_Sort);?>','<?php echo esc_js($array_exploded[0]);?>');
 				RW_Tabs_Doc_Style.setProperty('--rw_tabs_menu_item-h-c_<?php echo esc_js($RW_Tabs_Data_For_Sort);?>','<?php echo esc_js($array_exploded[1]);?>');
 				RW_Tabs_Doc_Style.setProperty('--rw_tabs_menu_item-a-c_<?php echo esc_js($RW_Tabs_Data_For_Sort);?>','<?php echo esc_js($array_exploded[2]);?>');
				<?php endif; 
				$RW_Tabs_Data_For_Sort++;
				endforeach; ?>
			});
		...
		<script>
			...
			function RW_Tabs_Refresh_Anim(anim) {
				return_animation<?php echo esc_html($Rich_Web_Tabs); ?>(anim);
			}
			(function($) {
				$.fn.turbotabs<?php echo esc_html($Rich_Web_Tabs); ?> = function(options) {
					...
					var random<?php echo esc_html($Rich_Web_Tabs); ?> = 'tab<?php echo esc_html($Rich_Web_Tabs); ?>-' + Math.floor(Math.random() * 100);  //tab--<TAB id> - random erknish tiv
					animation = settings<?php echo esc_html($Rich_Web_Tabs); ?>.animation; //Animatiayi type
					var myRW_Tabs_Window<?php echo $Rich_Web_Tabs;?> = '';
					...
					function RW_Tabs_MyClick_Tab_<?php echo esc_html($Rich_Web_Tabs); ?>(ClickedElement,RW_Tabs_RMode) {
						if (!$(ClickedElement).hasClass("active")) {
							...
							// var current<?php echo esc_html($Rich_Web_Tabs); ?> = jQuery(ClickedElement);
					...
					$(window).on("resize", function() {
						myRW_Tabs_Window<?php echo $Rich_Web_Tabs;?> = parseInt($(this).outerWidth());
						if (myRW_Tabs_Window<?php echo $Rich_Web_Tabs;?> > 553) {
							RW_Tabs_Fill_Container();
						} else if(myRW_Tabs_Window<?php echo $Rich_Web_Tabs;?> <= 553) {
							if ($('#RW_Tabs_T_Menu-H-<?php echo esc_html($Rich_Web_Tabs); ?>').attr('data-rw-mobile') == "accordion") {
							  $('#RW_Tabs_T_Menu-H-<?php echo  $Rich_Web_Tabs ;?> > .RW_Tabs_T_Item-H').each(function(){
							  	$('.Rich_Web_Tabs_tt_tab<?php echo  $Rich_Web_Tabs ;?>[data-parent="'+$(this).attr('data-id')+'"]').removeClass('Rich_Web_Tabs_animated').insertAfter(jQuery(this));
							  });
		  ...
		  <style id="RW_Tabs_Style">
			  	:root{
					...
					--rw_tabs_div_width:<?php echo filter_var(esc_attr($Rich_Web_Tabs_Theme_Prop->RWTabs_Width), FILTER_VALIDATE_INT); ?>%;
					--rw_tabs_menu_gap : <?php echo filter_var(esc_attr($Rich_Web_Tabs_Theme_Prop->RWTabs_M_Gap), FILTER_VALIDATE_INT); ?>px ;
					--rw_tabs_menu_content_gap : <?php echo filter_var(esc_attr($Rich_Web_Tabs_Theme_Prop->RW_Tabs_M_C_Gap), FILTER_VALIDATE_INT); ?>px ;
					...
					/* h3 borders */
					--rw_tabs_menu_item-br:<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_BR),FILTER_VALIDATE_INT); ?>px;
					--rw_tabs_menu_item-bw:<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_BW),FILTER_VALIDATE_INT); ?>px;
					--rw_tabs_menu_item-bs:<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_BS),FILTER_SANITIZE_STRING); ?>;
					--rw_tabs_menu_item-bc:<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_BC_B),FILTER_SANITIZE_STRING); ?>;
					--rw_tabs_menu_item-bc_h:<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_BC_H),FILTER_SANITIZE_STRING); ?>;
					--rw_tabs_menu_item-bc_a:<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_BC_A),FILTER_SANITIZE_STRING); ?>;
					/* h3 box shadows */
					--rw_tabs_menu_bsh_b:<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_Box_B),FILTER_SANITIZE_STRING); ?>;
					--rw_tabs_menu_bsh_h:<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_Box_H),FILTER_SANITIZE_STRING); ?>;
					--rw_tabs_menu_bsh_a:<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_Box_A),FILTER_SANITIZE_STRING); ?>;
					/* Right Icon  */
					--rw_tabs_menu_item-ri_c:<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_RI_C_B),FILTER_SANITIZE_STRING); ?>;
					--rw_tabs_menu_item-ri_c_h:<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_RI_C_H),FILTER_SANITIZE_STRING); ?>;
					--rw_tabs_menu_item-ri_c_a:<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_RI_C_A),FILTER_SANITIZE_STRING); ?>;
                    --rw_tabs_menu_item-ri_s:<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_RI_S),FILTER_VALIDATE_INT); ?>px;
					/* Left Icon  */
                    --rw_tabs_menu_item-li_c:<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_LI_C_B),FILTER_SANITIZE_STRING); ?>;
					--rw_tabs_menu_item-li_c_h:<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_LI_C_H),FILTER_SANITIZE_STRING); ?>;
					--rw_tabs_menu_item-li_c_a:<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_LI_C_A),FILTER_SANITIZE_STRING); ?>;
                    --rw_tabs_menu_item-li_s:<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_LI_S),FILTER_VALIDATE_INT); ?>px;
					/* Text Sizes */
					--rw_tabs_text_font_size :<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_FontSize),FILTER_VALIDATE_INT); ?>px;
					--rw_tabs_text_font_family :<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_Item_FontFamily),FILTER_SANITIZE_STRING); ?>;
					/* Content Styles */
					<?php if ($Rich_Web_Tabs_Theme_Prop->RWTabs_C_Type == 'color') { ?>
						--rw_tabs_content_bgc: <?php echo filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_C_Col_F), FILTER_SANITIZE_STRING);?>;
					...
					--rw_tabs_content_br:<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_C_BR),FILTER_VALIDATE_INT);?>px;
					--rw_tabs_content_bw:<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RWTabs_C_BW),FILTER_VALIDATE_INT);?>px;
					--rw_tabs_content_bc:<?php echo  filter_var(esc_html($Rich_Web_Tabs_Theme_Prop->RW_Tabs_C_BC),FILTER_SANITIZE_STRING);?>;
				}
				section#RW_Tabs_Section_T_H_<?php echo esc_html($Rich_Web_Tabs); ?>{
					width: 100% !important;
				...
				.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-bgc="style_bg_1"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3 {
					background: linear-gradient(to right, var(--rw_tabs_menu_item-bgc) 50%, var(--rw_tabs_menu_item-h-bgc) 50%);
				...
				.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-bgc="style_bg_2"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3 {
					background: linear-gradient(to left, var(--rw_tabs_menu_item-bgc) 50%, var(--rw_tabs_menu_item-h-bgc) 50%);
					background-size: 200% 100%;
				...
				.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-bgc="style_bg_3"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3 {
					...
					background-image: linear-gradient(to bottom, var(--rw_tabs_menu_item-bgc) 50%, var(--rw_tabs_menu_item-h-bgc) 50%);
				...
				.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-bgc="style_bg_4"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3 {
					background-size: 100% 200%;
					background-image: linear-gradient(to top, var(--rw_tabs_menu_item-h-bgc) 50%, var(--rw_tabs_menu_item-bgc) 50%);
					transition: background-position 1s;
					-webkit-transition: background-position 1s;
					-moz-transition: background-position 1s;
				}
				...
				.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3 {
					color: var(--rw_tabs_menu_item-c )!important;
					border-radius: var(--rw_tabs_menu_item-br);
					padding: 16px 12px;
					cursor: pointer;
					margin-top: 0 !important;
					margin-bottom: var(--rw_tabs_menu_gap) !important;
					padding-right: 40px;
					position: relative;
					transition: all 0.4s;
					-webkit-transition: all 0.4s;
					-moz-transition: all 0.4s;
					border:  var(--rw_tabs_menu_item-bw) var(--rw_tabs_menu_item-bs) var(--rw_tabs_menu_item-bc);
				...
				.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_1"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3 {
					box-shadow: 4px -4px var(--rw_tabs_menu_bsh_b);
				}
				.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_2"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3 {
					box-shadow: 5px 5px 3px var(--rw_tabs_menu_bsh_b);
				}
				.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_3"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3 {
					box-shadow: 2px 2px white, 4px 4px var(--rw_tabs_menu_bsh_b);
				}
				.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_4"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3 {
					box-shadow:  inset 0 0 18px 7px var(--rw_tabs_menu_bsh_b);
				}
				.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_5"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3 {
					box-shadow:  inset 8px 8px 18px var(--rw_tabs_menu_bsh_b);
				}
				.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_6"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3 {
					box-shadow:5px 5px 5px #a5aaab, 9px 9px 5px var(--rw_tabs_menu_bsh_b);
				}
				.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_9"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3 {
					box-shadow: 0 8px 6px -6px var(--rw_tabs_menu_bsh_b);
				}
				.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_15"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3 {
					box-shadow: 0 0 10px var(--rw_tabs_menu_bsh_b);
				}
					...
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_7"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:before, .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_15"] > h3:after {
					  ...
					  background:none;
					  z-index: -1;
					  box-shadow: 0 22px 14px var(--rw_tabs_menu_bsh_b);
					...
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_7"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover:before, .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_15"] > h3:hover:after {
						  ...
						  background:none;
						  z-index: -1;
						  box-shadow: 0 22px 14px var(--rw_tabs_menu_bsh_h);
						  -webkit-transform: rotate(-5deg);
						  -moz-transform: rotate(-5deg);
						  transform: rotate(-5deg);
					}
					...
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_7"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active:before, .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_15"] > h3.active:after {
						  ...
						  content:"";
						  left:15px;
						  bottom: calc(100% - var(--rw_tabs_text_font_size) - 5px);
						  bottom: -webkit-calc(100% - var(--rw_tabs_text_font_size) - 5px);
						  top:45%;
						  width:45%;
						  height: 5px;
						  background:none;
						  z-index: -1;
						  box-shadow: 0 22px 14px var(--rw_tabs_menu_bsh_a);
						  -webkit-transform: rotate(-5deg);
						  -moz-transform: rotate(-5deg);
						  transform: rotate(-5deg);
					}
					...
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_8"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:after {
						bottom: calc(100% - var(--rw_tabs_text_font_size) - 22px) !important;
						bottom: -webkit-calc(100% - var(--rw_tabs_text_font_size) - 22px) !important;
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_8"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:before{
					  box-shadow:85px -11px 13px 2px var(--rw_tabs_menu_bsh_b);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_8"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:after{
					  -webkit-transform: rotate(5deg);
					  -moz-transform: rotate(5deg);
					  ...
					  bottom: 11px;
					  top: auto;
					  box-shadow:84px -14px 13px 2px var(--rw_tabs_menu_bsh_b);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_8"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover:before {
						 box-shadow:85px -11px 13px 2px var(--rw_tabs_menu_bsh_h);
						  height: 5px;
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_8"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover:after {
						 box-shadow:84px -14px 13px 2px var(--rw_tabs_menu_bsh_h);
						  height: 5px;
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_8"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active:before {
						 box-shadow:85px -11px 13px 2px var(--rw_tabs_menu_bsh_a);
						  height: 5px;
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_8"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active:after {
						box-shadow:84px -14px 13px 2px var(--rw_tabs_menu_bsh_a);
						 height: 5px;
					}
				...
				.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_10"] >	.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:before,.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_10"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:after {
					  ...
					  background:none;
					  z-index: -1;
					  box-shadow: 0 22px 10px var(--rw_tabs_menu_bsh_b);
				...
				.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_10"] >	.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover:before,.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_10"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover:after {
						  ...
						  background:none;
						  z-index: -1;
						  box-shadow: 0 22px 10px var(--rw_tabs_menu_bsh_h);
						  -webkit-transform: rotate(-3deg);
						  -moz-transform: rotate(-3deg);
						  transform: rotate(-3deg);
					}
				...
				.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_10"] >	.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active:before,.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_10"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active:after {
						  position:absolute;
						  content:"";
						  bottom: calc(100% - var(--rw_tabs_text_font_size) - 0px);
						  bottom: -webkit-calc(100% - var(--rw_tabs_text_font_size) - 0px);
						  left: 8px;
						  top: 0;
						  width: 45%;
						  background:none;
						  z-index: -1;
						  box-shadow: 0 25px 10px var(--rw_tabs_menu_bsh_a);
						  -webkit-transform: rotate(-3deg);
						  -moz-transform: rotate(-3deg);
						  transform: rotate(-3deg);
					}
				.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_10"] >	.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active:after{
					...
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_11"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:before {
					  ...
					  background:none;
					  z-index: -1;
					  box-shadow: 0px 20px 14px var(--rw_tabs_menu_bsh_b);
					  -webkit-transform: rotate(-3deg);
					  -moz-transform: rotate(-3deg);
					  transform: rotate(-3deg);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_11"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover:before {
						  ...
						  background:none;
						  z-index: -1;
						  box-shadow: 0px 20px 14px var(--rw_tabs_menu_bsh_h);
						  -webkit-transform: rotate(-3deg);
						  -moz-transform: rotate(-3deg);
						  transform: rotate(-3deg);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_11"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active:before {
						  position:absolute;
						  content:"";
						  bottom: calc(100% - var(--rw_tabs_text_font_size) - 7px);
						  bottom: -webkit-calc(100% - var(--rw_tabs_text_font_size) - 7px);
					      left: 5px;
					       height: 5px;
					      width: 48%;
						  background:none;
						  z-index: -1;
						  box-shadow: 0px 20px 14px var(--rw_tabs_menu_bsh_a);
						  -webkit-transform: rotate(-3deg);
						  -moz-transform: rotate(-3deg);
						  transform: rotate(-3deg);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_12"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:before {
					  ...
					  width: 48%;
					  z-index: -1;
					  box-shadow: 0 19px 10px var(--rw_tabs_menu_bsh_b);
					  -webkit-transform: rotate(3deg);
					  -moz-transform: rotate(3deg);
					  transform: rotate(3deg);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_12"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover:before {
					    ...
					    width: 48%;
						z-index: -1;
						box-shadow: 0 19px 10px var(--rw_tabs_menu_bsh_h);
						-webkit-transform: rotate(3deg);
						-moz-transform: rotate(3deg);
						transform: rotate(3deg);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_12"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active:before {
					    ...
					    width: 48%;
						z-index: -1;
						box-shadow: 0 19px 10px var(--rw_tabs_menu_bsh_a);
						-webkit-transform: rotate(3deg);
						-moz-transform: rotate(3deg);
						transform: rotate(3deg);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_13"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:before {
					  ...
					  background:none;
					  z-index: -1;
					  box-shadow: 0 17px 20px var(--rw_tabs_menu_bsh_b);
					...
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_13"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover:before {
						  ...
						  background:none;
						  z-index: -1;
						  box-shadow: 0 17px 20px var(--rw_tabs_menu_bsh_h);
						  -webkit-transform: rotate(0deg);
						  -moz-transform: rotate(0deg);
						  transform: rotate(0deg);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_13"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active:before {
						  position:absolute;
						  content:"";
						  bottom: calc(100% - var(--rw_tabs_text_font_size) - 20px);
						  bottom: -webkit-calc(100% - var(--rw_tabs_text_font_size) - 20px);
					      left: 5%;
					      top: 0;
					      width: 90%;
						  background:none;
						  z-index: -1;
						  box-shadow: 0 17px 20px var(--rw_tabs_menu_bsh_a);
						  -webkit-transform: rotate(0deg);
						  -moz-transform: rotate(0deg);
						  transform: rotate(0deg);
					}
				.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_14"] >	.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:before,.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_14"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:after {
					    ...
					    background:none;
					    z-index: -1;
					    box-shadow: 0 0px 31px var(--rw_tabs_menu_bsh_b);
					    -webkit-transform: rotate(0deg);
					    -moz-transform: rotate(0deg);
					    transform: rotate(0deg);
					    border-radius: 50%;
				...
				.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_14"] >	.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover:before,.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_14"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover:after {
					    ...
					    background:none;
					    z-index: -1;
					    box-shadow: 0 0px 31px var(--rw_tabs_menu_bsh_h);
					    -webkit-transform: rotate(0deg);
					    -moz-transform: rotate(0deg);
					    transform: rotate(0deg);
					    border-radius: 50%;
				...
				.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_14"] >	.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active:before {
						position:absolute;
					    content:"";
					    bottom: calc(100% - var(--rw_tabs_text_font_size) - 31px);
					    bottom: -webkit-calc(100% - var(--rw_tabs_text_font_size) - 31px);
					    right: 0px;
					    top: 0;
					    width: 98%;
					    background:none;
					    z-index: -1;
					    box-shadow: 0 0px 31px var(--rw_tabs_menu_bsh_a);
					    transform: rotate(0deg);
					    -webkit-transform: rotate(0deg);
					    -moz-transform: rotate(0deg);
					    border-radius: 50%;
				...
				.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_14"] >	.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active:after {
					...
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-bgc="style_bg_5"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover { 
						box-shadow: inset 200px 100px 0 0 var(--rw_tabs_menu_item-h-bgc) !important;
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-bgc="style_bg_6"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover { 
						background-image: linear-gradient(-75deg, rgba(0,0,0,.1) 30%, var(--rw_tabs_menu_item-h-bgc) 50%, rgba(0,0,0,.1) 70%);
					    background-size: 200%;
					...
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-bgc="style_bg_7"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover { 
					   background-image: linear-gradient(-8deg, rgba(0,0,0,.6) 30%, var(--rw_tabs_menu_item-h-bgc) 50%, rgba(0,0,0,.6) 70%);
					   background-size: 200%;
					   animation: shine 1.5s infinite;
					}
					...
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_1"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover { 
						box-shadow: 7px -5px var(--rw_tabs_menu_bsh_h);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_2"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover { 
						box-shadow: 5px 5px 6px var(--rw_tabs_menu_bsh_h);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_3"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover { 
						box-shadow: 3px 3px white, 5px 5px var(--rw_tabs_menu_bsh_h);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_4"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover { 
						box-shadow:  inset 0 0 5px 5px var(--rw_tabs_menu_bsh_h);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_5"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover { 
						box-shadow:  inset 10px 10px 26px var(--rw_tabs_menu_bsh_h);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_6"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover { 
						box-shadow:5px 5px 5px #a5aaab, 9px 9px 5px var(--rw_tabs_menu_bsh_h);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_9"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover { 
						box-shadow: 0 8px 6px -6px var(--rw_tabs_menu_bsh_h);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_15"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover { 
						box-shadow: 0 0 10px var(--rw_tabs_menu_bsh_h);
					}
					.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover { 
						box-shadow: none;
					}
					.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover { 
						color: var(--rw_tabs_menu_item-h-c);
						border:  var(--rw_tabs_menu_item-bw) var(--rw_tabs_menu_item-bs) var(--rw_tabs_menu_item-bc_h);
					}
					.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover i#rich-web-acd-icon<?php echo esc_html($Rich_Web_Tabs); ?> {
						color: var(--rw_tabs_menu_item-li_c);
					}
					...
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_1"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active { 
						box-shadow: 7px -5px var(--rw_tabs_menu_bsh_a);		
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_2"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active { 
						box-shadow: 5px 5px 6px var(--rw_tabs_menu_bsh_a);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_3"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active { 
						box-shadow: 3px 3px white, 5px 5px var(--rw_tabs_menu_bsh_a);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_4"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active { 
						box-shadow:  inset 0 0 5px 5px var(--rw_tabs_menu_bsh_a);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_5"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active { 
						box-shadow:  inset 10px 10px 26px var(--rw_tabs_menu_bsh_a);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_6"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active { 
						box-shadow:5px 5px 5px #a5aaab, 9px 9px 5px var(--rw_tabs_menu_bsh_a);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_9"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active { 
						box-shadow: 0 8px 6px -6px var(--rw_tabs_menu_bsh_a);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-box="style_bsh_15"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active { 
						box-shadow: 0 0 10px var(--rw_tabs_menu_bsh_a);
					}
					.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active {
						background: var(--rw_tabs_menu_item-a-bgc) !important;
						color: var(--rw_tabs_menu_item-a-c) !important;
						border:  var(--rw_tabs_menu_item-bw) var(--rw_tabs_menu_item-bs) var(--rw_tabs_menu_item-bc_a);
						box-shadow: none;
						transition: none ;
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-text="style_ti_1"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3 span{
						text-shadow: 0 0 4px var(--rw_tabs_menu_item-c) !important;
					    color: transparent;
					...
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-text="style_ti_2"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3 span{
						text-shadow: 1px 1px 0  var(--rw_tabs_menu_item-c),
		                1px -1px 0  var(--rw_tabs_menu_item-c),
		                -1px 1px 0  var(--rw_tabs_menu_item-c),
		                -1px -1px 0  var(--rw_tabs_menu_item-c) !important;
					...
					.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover .arrowDown<?php echo esc_html($Rich_Web_Tabs); ?> {
						border-color: var(--rw_tabs_menu_item-h-bgc) transparent transparent transparent;
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-text="style_ti_1"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover span {
						text-shadow: 0 0 0 var(--rw_tabs_menu_item-h-c) !important;
					}					
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-text="style_ti_2"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover span {
						text-shadow: 1px 1px 0 var(--rw_tabs_menu_item-h-c), 1px -1px 0 yellowgreen, -1px 1px 0 var(--rw_tabs_menu_item-h-c), -1px -1px 0 var(--rw_tabs_menu_item-h-c) !important;
		    			color: white;
					}					
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-text="style_ti_3"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover span {
						text-shadow: 1px 1px 0 var(--rw_tabs_menu_item-h-c),
		                1px -1px 0 #aaaaaa,
		                2px -2px 0 #dbdbdb,
		                3px -3px 0 #eaeaea !important;
		    			color:var(--rw_tabs_menu_item-h-c);
					...
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-bgc="style_bg_5"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3:hover .arrowDown<?php echo esc_html($Rich_Web_Tabs); ?> {
						border-color: var(--rw_tabs_menu_item-h-bgc) transparent transparent transparent !important;
					}
					...
					.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active span {
						text-shadow: none;
						color: var(--rw_tabs_menu_item-a-c);
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-text="style_ti_2"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active span {
						text-shadow: 1px 1px 0 var(--rw_tabs_menu_item-a-c), 1px -1px 0 var(--rw_tabs_menu_item-a-c), -1px 1px 0 var(--rw_tabs_menu_item-a-c), -1px -1px 0 var(--rw_tabs_menu_item-a-c) !important;
		    			color: white;
					}
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-rw-text="style_ti_3"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active span {
						text-shadow: 1px 1px 0 var(--rw_tabs_menu_item-a-c),
		                1px 1px 0 #aaaaaa,
		                2px 2px 0 #dbdbdb,
		                3px 3px 0 #eaeaea !important;
		    			color:var(--rw_tabs_menu_item-a-c);
					...
					.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active i#rich-web-acd-icon<?php echo esc_html($Rich_Web_Tabs); ?> {
						color: var(--rw_tabs_menu_item-li_c_a);
					}
					.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3.active div.collapseIcon<?php echo esc_html($Rich_Web_Tabs); ?> {
						color: var(--rw_tabs_menu_item-ri_c_a);
					}
					...
					.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3 i#rich-web-acd-icon<?php echo esc_html($Rich_Web_Tabs); ?> {
						color: var(--rw_tabs_menu_item-ri_c);
						font-size: var( --rw_tabs_menu_item-li_s);
						width: var( --rw_tabs_menu_item-li_s);
						position: absolute;
						top: 50%;
						left:12px;
						z-index: 9;
					...
					.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3 i#rich-web-acd-icon<?php echo esc_html($Rich_Web_Tabs); ?>:hover {
						color: var(--rw_tabs_menu_item-li_c_h);
					}
					...
					.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3 div.collapseIcon<?php echo esc_html($Rich_Web_Tabs); ?> i {
						color: var(--rw_tabs_menu_item-ri_c);
						font-size: var( --rw_tabs_menu_item-ri_s);
						width: var( --rw_tabs_menu_item-ri_s);
						position: relative;
						z-index: 9;
					}
					...
					.Rich_Web_Tabs_Accordion_<?php echo esc_html($Rich_Web_Tabs); ?>[data-style="gradient"] > .Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > div {
						background: var(--rw_tabs_content_bgc);
						background: -webkit-linear-gradient(left, var(--rw_tabs_content_bgc), var(--rw_tabs_content_bgc2));
						background: -o-linear-gradient(right, var(--rw_tabs_content_bgc), var(--rw_tabs_content_bgc2));
						background: -moz-linear-gradient(right, var(--rw_tabs_content_bgc), var(--rw_tabs_content_bgc2));
						background: linear-gradient(to right, var(--rw_tabs_content_bgc), var(--rw_tabs_content_bgc2));
					}
					...
					.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > div {
						...
						text-align: left;
						padding: 20px;
						margin: var(--rw_tabs_menu_content_gap) 0 10px 0;
					}
					.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> .arrowDown<?php echo esc_html($Rich_Web_Tabs); ?> {
						...
						border-color: var(--rw_tabs_menu_item-bgc) transparent transparent transparent;
						position: absolute;
						bottom: 0;
						left: 40px;
						opacity: 0;
					...
					.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> .active .arrowDown<?php echo esc_html($Rich_Web_Tabs); ?> {
						bottom: -13px;
						border-color: var(--rw_tabs_menu_item-a-bgc) transparent transparent transparent;
						opacity: 1;
					}
					.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> .collapseIcon<?php echo esc_html($Rich_Web_Tabs); ?> {
						position: absolute;
						color:var(--rw_tabs_menu_item-ri_c);
						font-size: var(--rw_tabs_menu_item-ri_s) !important;
						right: 0;
						top: 50%;
						font-size: 25px;
						font-weight: 300;
					...
					.Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > h3 span.rw_tabs_act_st_title {
						font-family: var(--rw_tabs_text_font_family);
						font-size: var(--rw_tabs_text_font_size) !important;
						position: relative;
						z-index: 2;
						display: inline-block;
						left: calc(var(--rw_tabs_text_font_size) + 10px);
						left: -webkit-calc(var(--rw_tabs_text_font_size) + 10px);
						line-height: var(--rw_tabs_text_font_size) !important;
						margin-right: 70px;
						margin-left: calc(var(--rw_tabs_menu_item-li_s) - 5px);
						margin-left: -webkit-calc(var(--rw_tabs_menu_item-li_s) - 5px);
					}
		  ...
		  <section id="RW_Tabs_Section_T_H_<?php echo esc_html($Rich_Web_Tabs); ?>">
					...
					<?php if ($RW_Tabs_New_Tab != true) { 
						for ($i = 0; $i < count($Rich_Web_Tabs_Fields); $i++) { ?>
				<div class="Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?>" data-sort="<?php echo  $i + 1 ;?>" >
					...
					<div class="rw_tabs_acd_cont<?php echo esc_html($Rich_Web_Tabs); ?>" >
						<div id="rw_tabs_acd_cont<?php echo esc_html($Rich_Web_Tabs); ?>">
							<?php echo wp_specialchars_decode($Rich_Web_Tabs_Fields[$i]->Tabs_Content); ?>
						</div>
					</div>
				</div>
 		<?php } }else{
		for ($n=1; $n < 4; $n++) :  ?>
				<div class="Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?>" data-sort="<?php echo  esc_attr($n) ;?>">
					<h3 class="Rich_Web_Tabs_h3_<?php echo esc_html($Rich_Web_Tabs); ?>">
						<i id="rich-web-acd-icon<?php echo esc_html($Rich_Web_Tabs); ?>" class='rich_web'></i>
						<div class="rw_tabs_act_st_div_l<?php echo esc_html($Rich_Web_Tabs); ?>"><span class="rw_tabs_act_st_l<?php echo esc_html($Rich_Web_Tabs); ?>"></span></div>
						<span class="rw_tabs_act_st_r<?php echo esc_html($Rich_Web_Tabs); ?>"></span>
						<span class="rw_tabs_act_st_title"> Accordion <?php echo  esc_html($n); ?></span>
					</h3>
					<div class="rw_tabs_acd_cont<?php echo esc_html($Rich_Web_Tabs); ?>">
						<div id="rw_tabs_acd_cont<?php echo esc_html($Rich_Web_Tabs); ?>">
                                 Accordion <?php echo  esc_html($n); ?> Content
						</div>
					</div>
				</div>
		<?php  endfor;  } ?>
				...
				function RW_Tabs_Change_Anim(RWTabs_NewAnim) {
					RW_Tabs_Cont_Anim = RWTabs_NewAnim;
					RW_Tabs_Refresh_Acd();
				}
				...
				jQuery(document).ready(function() {
					...
					// jQuery(".Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > div").css("height","auto");
					// jQuery(".Rich_Web_Tabs_Accordion_Content_<?php echo esc_html($Rich_Web_Tabs); ?> > div").css("display","none");
				});
				jQuery(document).ready(function() {
...
<script>
	function RW_Tabs_Responsive_Scroll(RW_Tabs_myTabId) {
		document.getElementById("RW_Tabs_Section_T_H_"+RW_Tabs_myTabId).scrollIntoView({behavior: "smooth", block: "end", inline: "nearest"});
	}
</script>
